...
public static class ApplicationErrors
{
    ...
    public static Error LaborNotAssignable =>
        Error.Conflict(
            "Employee.LaborNotAssignable",
            "The selected employee is not an active laborer.");

    public static Error EmployeeNotFound =>
        Error.NotFound("Employee.NotFound", "Employee does not exist.");

    public static Error LastActiveManagerCannotBeDeactivated =>
        Error.Conflict(
            "Employee.LastActiveManager.CannotDeactivate",
            "You cannot deactivate or demote the only active manager. Add another active manager first.");
}
