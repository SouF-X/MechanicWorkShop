...
public static class DependencyInjection
{
    public static IServiceCollection AddInfrastructure(this IServiceCollection services, IConfiguration configuration)
    {
        ...
        }).AddJwtBearer(options =>
        {
            ...
            options.Events = new JwtBearerEvents
            {
                OnTokenValidated = async context =>
                {
                    ...
                    {
                        context.Fail("The token does not contain a valid user ID.");
                        return;
                    }

                    var userStatusService = context.HttpContext.RequestServices
                        .GetRequiredService<IUserStatusService>();

                    var isActive = await userStatusService.IsActiveAsync(
                        userId,
        ...
        services.Configure<FirstManagerSettings>(configuration.GetSection("FirstManager"));
        services.AddScoped<FirstManagerBootstrapper>();
